    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-4 sm:p-6 flex flex-col min-h-[calc(100vh-8rem)] relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                ...
                <Link 
                    href="/dashboard/settings/presence-categories"
                    className="border border-slate-200 rounded-xl p-5 bg-slate-50/80 hover:bg-orange-50/50 hover:border-orange-300 transition-colors group cursor-pointer h-full flex flex-col"
                >
                    <div className="flex items-center gap-3 mb-4 flex-1">
                        ...
                        <div>
                            <h2 className="font-semibold text-slate-800 group-hover:text-orange-700 transition-colors">Master Kategori Peserta</h2>
                            <p className="text-xs text-slate-500">
                                Pengaturan kategori peserta (umum, pasien, penunggu).
                            </p>
                        </div>
                    </div>
                    <div className="flex items-center text-orange-600 text-sm font-medium mt-auto group-hover:underline">
                        Akses Menu <ChevronRight size={16} className="ml-1 transition-transform group-hover:translate-x-1" />
                    </div>
                </Link>
            </div>
